							...
							<div class="col-lg-12">
								<section class="panel">
                                    ...
                                    <?php
										...
										$show=mysql_query("select * from product_category where unique_id='$unique_id'") or die(mysql_error());
									...
									?>
										...
										<form class="form-horizontal form-bordered" action="update_catego.php" method="post">
