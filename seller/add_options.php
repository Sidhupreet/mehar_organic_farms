							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Add More Fields</h2>
									</header>
									...
									?>
										...
										<form class="form-horizontal form-bordered" action="addoptions.php" method="post">
                                        ...
                                        <input type="hidden" name="product_unique_id" value="<?php echo $product_unique_id;?>">
                                            ...
                                            <div class="form-group">
												...
												<div class="col-md-6">
                                                    ...
                                                    placeholder="Add Label" required>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-md-6">
                                                   ...
                                                   placeholder="Add Value" required>
												</div>
											</div>
                                           
 											
										<center>
										<button type="submit" class="mb-xs mt-xs mr-xs btn btn-info">Submit</button>
                                        </center>
