...
<body>
                        ...
                        <div class="col-md-9 primary-content">
                            <article class="article-content">
                                ...
                                <div class="single-shop">
                                    ...
                                    <?php 
			$show=mysql_query("select * from product_details where product_unique_id='".$product_unique_id."' and is_del='no'");
 ...
 <!----------------------------------------------------------------Product Description-------------------------------------------------------------------->             
               ...
               <?php 
								 $show=mysql_query("select * from product_description where product_unique_id='".$product_unique_id."' and is_del='no'");
...
window.onclick = function(event) {
    if (event.target == modal) {
        modal.style.display = "none";
                                    ...
                                    <!--------------------------Review------------------------->
                                      <?php 
								 $show123=mysql_query("select * from product_review where product_unique_id='".$product_unique_id."' and is_del='no'");
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane in active" id="tab-description">
                                                <div class="product-tabs-entry-content">
                                                    ...
                                                    <table>
                                                      <?php  $show1=mysql_query("select * from add_option where product_unique_id='".$product_unique_id."' and is_del='no'");
			  ...
			  ?>                   
                                            ...
                                            <?php } else echo '<br><center>'."Product Review Not Added..!";?>
                                              ...
                                              <?php 
								 $show22=mysql_query("select * from product_brochure where product_unique_id='".$product_unique_id."' and is_del='no'");
