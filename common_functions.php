...
?>
 ...
 <meta charset="UTF-8">
    ...
    <title>Mehar Organic Farms</title>
            ...
            <div class="container">
                <div class="pull-left hidden-xs hidden-sm">
                    <ul class="header-information">
                        <li><i class="fa fa-krw color"></i> &nbsp;Welcome to Mehar Organic Farms.</li>
                        <li><i class="fa fa-phone color"></i> &nbsp;Call us: 0223993684</li>
                        <li><i class="fa fa-envelope color"></i> &nbsp;Email us: <a href="#">sales@meharfarms.in</a></li>
                    </ul>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-2 col-lg-3">
                                <div class="header-brand">
                                    <a href="index.php">
                                     <img src="images/Mehar_organic_farm1.png" style="margin-top:20px; height:50px;" alt="meher organic farm">
...
--->                                        
                                        ...
                                        <li><a href="contact.php">Contact Us</a> </li>
                                         <li><a href="http://localhost/mehar_organic_farms/seller/index.php"  class="btn-yellow text-uppercase" id="myBtn">Seller Login</a> </li>
                                         <li> 
                        ...
                        <div class="footer-page">
                            <div class="row">
                                <div class="col-sm-10 copyright">
									Copyrights <?php echo date("Y")?>&nbsp; &nbsp;<a href="http://www.highclonoidsoftec.com">@ MEHAR ORGANIC FARMS</a>
                                </div>
...
<li><a href="category.php?category=<?php echo $category1 ?>" class="second-text-color"><i class="fa fa-caret-right"></i> <?php echo $category ?></a> </li>
                            ...
                            <?php 
		$show1=mysql_query("select  DISTINCT(`sub_category`),unique_id from product_category where category='".$rw['category']."' and is_del='no'");
									echo "<ul>";
									while($rw1=mysql_fetch_array($show1))
									{ 
									$sub_category1=$rw1['sub_category'];
									echo "<li>";
									echo "<a href=subcatego.php?sub_category=".$rw1['unique_id']." class=second-text-color>"."-"." ";
