					...
					<header class="page-header">
						...
						<div class="right-wrapper pull-right">
							<ol class="breadcrumbs">
								...
								<li><span>Brochure Entry Form</span></li>
							</ol>
					...
					<div class="row">
							<div class="col-lg-12">
								<section class="panel">
									...
									?>
										<form class="form-horizontal form-bordered" action="addreview.php" method="post">
                                        <input type="hidden" value="<?php echo $product_unique_id;?>" name="product_unique_id">
                                            ...
                                            <div class="form-group">
												<label class="col-md-3 control-label" for="textareaDefault">Type A Review</label>
												<div class="col-md-6">
													<textarea class="form-control" rows="3" name="review" id="review" required></textarea>
												</div>
											</div>
