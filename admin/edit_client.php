...
$res = mysql_query("select * from client_details where client_unique_id='".$_GET['client_unique_id']."' and is_del='no'")or die(mysql_error());
...
?>
							...
							<div class="col-lg-12">
								...
								<section class="panel">
									...
									<div class="panel-body">
										...
										<form class="form-horizontal form-bordered" action="update_client.php" method="post" enctype="multipart/form-data">

                                               <div class="form-group">

											   

											   <input type="hidden" name="client_unique_id" value="<?php echo $client_unique_id;?>">
												...
												<div class="col-md-6">
													...
													<input type="text" class="form-control" id="client_name" value="<?php echo $row['client_name']; ?>" name="client_name" >
												...
												<div class="col-md-6">
													...
													<input type="text" class="form-control" id="contact" value="<?php echo $row['contact']; ?>" name="contact" >
                                             ...
                                             <div class="form-group">
												...
												<div class="col-md-6">
													...
													<textarea class="form-control" rows="3" name="address" value="<?php echo $row['address']; ?>" id="address" title="Address" ><?php echo $row['address']; ?></textarea>
				...
				<textarea class="form-control" rows="3" name="descr" value="<?php echo $row['descr']; ?>" id="descr" title="Description"><?php echo $row['descr']; ?></textarea>
                                             ...
                                             <div class="form-group">
												...
												<img src="<?php echo 'img/client/'.$row['photo']; ?>"  style="width:50px;height:50px;" />
												...
												?>
													...
													<input type="file" class="form-control" id="photo" value="<?php echo $row['photo']; ?>" name="photo">
