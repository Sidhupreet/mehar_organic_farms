							...
							<div class="col-lg-12">
								<section class="panel">
									<header class="panel-heading">
										...
										<h2 class="panel-title">Add New Subcategory Category</h2>
									</header>
										...
										<form class="form-horizontal form-bordered" action="addsubcatego.php" method="post">
                                           ...
                                           <div class="form-group">
												...
												<div class="col-md-6">
													...
													<select class="form-control mb-md" name="category" id="category" onChange="getCategory(this.value);"  required>
