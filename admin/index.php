...
<head>
		...
		<meta name="keywords" content="mehar organic farm" />
		<meta name="description" content="mehar organic farm">
						...
						<form action="check_login.php" method="post">
							<div class="form-group mb-lg">
								...
								<div class="input-group input-group-icon">
									<input name="myusername" type="text" class="form-control input-lg" />
