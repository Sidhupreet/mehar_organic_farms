						...
						<section class="panel">
							...
							<div class="panel-body">
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
                                    <?php 
									$show=mysql_query("select * from product_details where is_del='no' and review_status='not_added'") or die(mysql_error());
									...
									?>
										...
										<tr class="gradeU">
                                            ...
                                            <td><?php echo "<a href=reviewadd.php?product_unique_id=".$row['product_unique_id']."><strong>Add Review</strong></a>";
										   ?></td>
