...
$category_shital1=$_GET['category'];
$category_shital=str_replace('_',' ',$category_shital1);
 ...
 $show=mysql_query("select * from product_details where category='".$category_shital1."' and is_del='no' and final_status='yes'");
								/*
								 if (mysql_num_rows($show) == 0)
								 {
									 echo "<div class=col-lg-10 col-md-10 col-sm-9 col-xs-12>
                                    <h4><center>Ooops....! No Products Found For ".$category_shital." Category..!</center></h4>
								    </div>";
								 } */
                                ...
                                <div class="product-listing-wp">
                                    ...
                                    <div class="product-title-wp clearfix">
                                        <div class="product-title" align="center">
                                         <center>   All Products Of <?php echo $category_shital ?></center>
                                        </div>
