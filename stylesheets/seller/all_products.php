						...
						<section class="panel">
							...
							<div class="panel-body">
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
                                    <?php 
									$show=mysql_query("select * from product_details where is_del='no'") or die(mysql_error());
									...
									?>
										...
										<tr class="gradeU">
											...
											<td class="actions">
                                            <?php echo "<a href=edit_product.php?product_unique_id=".$row['product_unique_id'].">Edit</a>"; ?>
											<?php echo "<a href=delete_product.php?product_unique_id=".$row['product_unique_id'].">Delete</a>"; ?>
                                            <?php echo "<button><a href=../preview.php?product_unique_id=".$row['product_unique_id'].">Preview</a></button>"; ?>
