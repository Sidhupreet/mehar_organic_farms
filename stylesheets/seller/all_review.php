						...
						<section class="panel">
							...
							<div class="panel-body">
								<table class="table table-bordered table-striped mb-none" id="datatable-default">
									...
									<tbody>
                                    <?php 
									$show=mysql_query("select * from product_review where is_del='no'") or die(mysql_error());
					...
					$show1=mysql_query("select * from product_details where product_unique_id='$product_unique_id' and is_del='no'") or die(mysql_error());
									...
									?>
										<tr class="gradeU">
											...
											<td class="actions">
                                            <?php echo "<a href=edit_review.php?product_unique_id=".$row['product_unique_id'].">Edit</a>"; ?>
											<?php echo "<a href=delete_review.php?product_unique_id=".$row['product_unique_id'].">Delete</a>"; ?>
